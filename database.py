...
# Render sometimes uses 'postgres://' which SQLAlchemy asyncpg dislikes; replace with 'postgresql+asyncpg://'
...
class Booking(Base):
    ...
    id: Mapped[str] = mapped_column(String(30), primary_key=True) # e.g. RNT-20260826-1234
...
class WalletTransaction(Base):
    ...
    type: Mapped[str] = mapped_column(String(50)) # COMMISSION, TOP_UP
